    ...
    >
      <div className="container">
        ...
        >
          ...
          <div className="navbar-text d-flex gap-3 justify-content-between">
            <span className="form-check form-switch d-flex justify-content-between gap-3">
              ...
              <input
                className="form-check-input cursor-pointer ml-0"
                type="checkbox"
                id="theme"
